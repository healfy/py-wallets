...
_GETBALANCEBYSLUGREQUEST = _descriptor.Descriptor(
  ...
  serialized_options=_b('\222A\"\n *\027Get Transaction by Hash\322\001\004slug'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_BLOCKCHAINGATEWAYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\025\"\020/wallets/balance:\001*\222AJ\022#Get balance of all platform wallets\032#Get balance of all platform wallets'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=_GETBALANCERESPONSE,
    serialized_options=_b('\202\323\344\223\002\024\"\017/balance/{slug}:\001*\222AN\022%Get balance of single platform wallet\032%Get balance of single platform wallet'),
  ),
  _descriptor.MethodDescriptor(
